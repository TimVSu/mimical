...
const Logo = () => {
    return (
        ...
        //         <View style={[{ backgroundColor: 'white' }, { width: 8 }, { height: 8 }, { borderWidth: 0 }, { borderRadius: 4 }, { marginTop: 4 }, { marginLeft: 4 }]}></View>
        ...
        //         <View style={[{ backgroundColor: light_primary_color }, { width: 8 }, { height: 8 }, { borderWidth: 0 }, { borderRadius: 4 }, { marginTop: 4 }, { marginLeft: 4 }]}></View>
        ...
        //         <View style={[{ backgroundColor: 'white' }, { width: 12 }, { height: 12 }, { borderWidth: 0 }, { borderRadius: 6 }, { marginTop: 6 }, { marginLeft: 6 }]}></View>
        ...
        //         <View style={[{ backgroundColor: light_primary_color }, { width: 12 }, { height: 12 }, { borderWidth: 0 }, { borderRadius: 6 }, { marginTop: 6 }, { marginLeft: 6 }]}></View>
